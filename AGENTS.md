...
`games/lost-and-found`, `games/rare-invaders` (user requested Genesis play on 2026-09-23), `games/rare-drop`, `games/rare-rush`, `games/rare-quest` (same holder, 2026-09-24) and `games/rare-delve` (same holder, 2026-09-25), `allowGenesisPreview: true` opts into verified Genesis
