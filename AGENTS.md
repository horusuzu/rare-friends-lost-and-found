...
`games/lost-and-found`, `games/rare-invaders` (user requested Genesis play on 2026-09-23), `games/rare-drop`, `games/rare-rush` and `games/rare-stickers` (same holder, 2026-09-24), `allowGenesisPreview: true` opts into verified Genesis
